...
## 目录
- [框架概述](#框架概述)
- [TUniModelAdmin 组件](#tunimodeladmin-组件)
- [元数据配置](#元数据配置)
- [快速开始](#快速开始)
- [高级功能](#高级功能)
- [最佳实践](#最佳实践)
...
CRUD 框架是 UniAdmin 的核心功能之一，通过 `TUniModelAdmin` 组件实现零代码的增删改查操作。开发者只需配置元数据，框架自动生成完整的 CRUD 界面和逻辑。
...
CRUD 框架通过 `TUniModelAdmin` 组件和元数据配置，实现了零代码的增删改查功能。开发者只需关注业务逻辑，框架自动处理界面生成、数据验证、权限控制等通用功能，大大提高了开发效率。
