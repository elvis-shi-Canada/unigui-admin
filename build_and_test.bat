...
for %%f in (
    ...
    "Core\Plugin\UniAdminModuleRegistry.Intf.pas"
    "Core\Plugin\UniAdminModuleRegistry.pas"
    "Core\Plugin\UniModuleRegistration.pas"
    "Core\Data\UniAdminDataModule.pas"
    "Core\Data\UniAdminConnectionManager.pas"
    "Core\Metadata\UniAdminMetadataCache.pas"
    "Core\Auth\UniAdminAuthService.pas"
    "Core\Menu\UniAdminMenuManager.pas"
    "Core\Menu\SystemMenuSetup.pas"
    "Core\Permission\UniAdminPermissionManager.pas"
    "Core\Services\UniAdminServices.pas"
) do (
    set "FILE=%SRC_DIR%\%%f"
    if exist "!FILE!" (
        echo   编译: %%~nxf
